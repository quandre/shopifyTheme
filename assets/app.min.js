let homeController = new ScrollMagic.Controller(),
  jumboNodes = document.querySelectorAll(".jumbo-section"),
  twoCollectionsNodes = document.querySelectorAll(".twoCollections-section"),
  horizontalSaleNodes = document.querySelectorAll(".horizontal-sale-section"),
  productsGroupNodes = document.querySelectorAll(".products-group-section"),
...
headerTL
  .fromTo(
    ...
    { backgroundColor: "rgba(0,0,0,1)", duration: 0.4 }
  )
  .fromTo(
    "header .logo a",
    { scale: 1 },
    { scale: 0.8, duration: 0.4 },
    ">-.4"
  );
...
null != jumboNodes &&
  jumboNodes.forEach((e) => {
    gsap
      ...
      .fromTo(
        e.querySelectorAll(".state"),
        { x: "100%" },
        { x: 0, duration: 1 }
      )
      .fromTo(
        e.querySelectorAll(".store-info"),
        { y: "100%" },
        { y: 0, duration: 1 },
        ">-1.8"
      )
      .fromTo(
        e.querySelectorAll(".store-info img"),
        { y: 400, opacity: 0 },
        { y: 0, opacity: 1, duration: 1, stagger: 0.2 },
        ">-1.8"
      );
  }),
  null != twoCollectionsNodes &&
    twoCollectionsNodes.forEach((e) => {
      let o = gsap.timeline();
      o.fromTo(
        e.querySelectorAll(".col-md-6"),
        { y: 300, opacity: 0 },
        { y: 0, opacity: 1, duration: 1 }
      )
        .fromTo(
          e.querySelectorAll(".left-c span"),
          { y: 300, opacity: 0 },
          { y: 0, opacity: 1, duration: 1 }
        )
        .fromTo(
          e.querySelectorAll(".right-c span"),
          { y: 300, opacity: 0 },
  ...
  null != horizontalSaleNodes &&
    horizontalSaleNodes.forEach((e) => {
      ...
      o.fromTo(e, { opacity: 0 }, { opacity: 1 })
        .fromTo(
          e.querySelectorAll(".percent-number"),
          { scale: 0 },
          { scale: 1, duration: 1 }
        )
        .fromTo(
          e.querySelectorAll(".title"),
          { scale: 0 },
          { scale: 1 },
          ">-1"
        );
  ...
  null != productsGroupNodes &&
    productsGroupNodes.forEach((e) => {
      const o = gsap.timeline();
      o.fromTo(
        e.querySelectorAll(".product-bg"),
        { opacity: 0, y: 100 },
        { opacity: 1, y: 0, stagger: 0.3, duration: 0.3 }
      );
      new ScrollMagic.Scene({
        triggerElement: e,
        triggerHook: 1,
...
let footerScene = new ScrollMagic.Scene({
  ...
  .setTween(footerTL)
  .addTo(homeController);
const mobileMenuTL = gsap.timeline({ paused: !0 });
mobileMenuTL
  .fromTo("#mobile-menu", { x: "-100%" }, { x: 0, duration: 0.8 })
  .fromTo(
